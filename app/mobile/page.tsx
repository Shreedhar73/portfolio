      ...
      <div className="md-wrap">
        ...
        <section className="md-hero">
          <div>
            ...
            <h1>
              I build apps that survive <span className="grad">bad networks</span> and ship on time.
            </h1>
            <p className="lede">
              4+ years of production Flutter — offline-first architecture, Clean Architecture with
              Bloc, and generative-AI features that earn their place. 10+ apps on Google Play and the
              App Store, zero store rejections.
            </p>
            <BootLog />
            <div className="md-cta">
              ...
              <a className="md-btn ghost" href={profile.playStore} rel="noopener">
                Google Play ↗
              </a>
            </div>
          </div>
        ...
        <section className="md-sec" id="apps">
          <Rv className="md-sec-h">
            ...
            <span className="n">{mobileProjects.length} apps · Play + App Store</span>
          </Rv>
            ...
            {mobileProjects.map((p, idx) => {
              ...
              return (
                <Rv key={p.name} delay={(idx % 2) * 0.08}>
                  <article className="md-card" style={{ ['--ac' as string]: ac }}>
                    <div className="top">
                      <div className="badge-ico">{m?.initials ?? short.slice(0, 2)}</div>
                      <div>
                        <h3>{short}</h3>
            ...
            <div className="md-pubspec">
              ...
              <div className="code mono">
                <span className="ln">
                  ...
                  <span className="k">:</span> <span className="v">shreedhar_pandeya</span>
                </span>
                <span className="ln">
                  <span className="key">description</span>
                  <span className="k">:</span>{' '}
                  <span className="v">Mobile engineer &amp; full-stack builder.</span>
                </span>
                <span className="ln">
                ...
                {DEPS.map((d) => (
                  <span className="ln dep" key={d.name}>
                    ...
                    <span className="k">:</span> <span className="v">{d.ver}</span>
                  </span>
                ))}
              </div>
            </div>
        ...
        <Rv>
          <section className="md-contact">
            ...
            <p>
              Flutter, offline-first sync, native bridges, AI features — from architecture to a
              clean store release. Let&apos;s build it.
            </p>
            <div className="md-cta">
