...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Google Play', href: 'https://play.google.com/store/apps/details?id=com.onlyever' },
    ],
  },
  {
    ...
    links: [
      { label: 'Google Play', href: 'https://play.google.com/store/apps/details?id=com.ict_supprt.kapurkot' },
    ],
  },
  {
    ...
    links: [
      { label: 'Google Play', href: 'https://play.google.com/store/apps/details?id=np.org.muannepal' },
    ],
  },
  {
    ...
    links: [
      { label: 'Google Play', href: 'https://play.google.com/store/apps/details?id=sg.app.levelup' },
    ],
  },
  {
